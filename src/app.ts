...
app.set('views', path.join(rootDir, 'web_page', 'views')); //Cấu hình đường dẫn đến thư mục chứa các file giao diện người dùng

app.use('/favicon.ico', faviconController.getFaviconResponse);
...
app.use(express.static(path.join(rootDir, 'web_page'))); //Cấu hình middleware để phục vụ các tệp tĩnh (ví dụ: CSS, JavaScript, hình ảnh, v.v...)
